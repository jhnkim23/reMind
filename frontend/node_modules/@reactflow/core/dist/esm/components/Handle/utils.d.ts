...
import { ConnectingHandle, ConnectionMode, ConnectionStatus } from '@reactflow/packages/core/src/types';
import type { Connection, HandleType, XYPosition, Node, NodeHandleBounds } from '@reactflow/packages/core/src/types';
